...
/** Minimum time between accepted captures for the same seat (any signal type). 8s — client `CAPTURE_COOLDOWN_MS` must match. */
const SEAT_CAPTURE_COOLDOWN_MS = 8 * 1000;
